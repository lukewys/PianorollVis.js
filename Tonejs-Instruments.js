...
var SampleLibrary = {
    ...
    baseUrl: './samples/',
    list: ['bass-electric', 'bassoon', 'cello', 'clarinet', 'contrabass', 'flute', 'french-horn', 'guitar-acoustic',
        'guitar-electric', 'guitar-nylon', 'harmonium', 'harp', 'organ', 'piano', 'saxophone', 'trumpet', 'tuba',
        'violin', 'xylophone', 'marimba', 'metronome', 'bell', 'Bassoon-VPO', 'Horn-VPO', 'Trombone-VPO',
        'Vibraphone-VPO', 'Viola-VPO', 'Violin-VPO'],
    onload: null,
    ...
    // from https://github.com/mrmrmrfinch/BachDuet-WebGUI/tree/main/public/audio/samples/metronome
    // original "C0.mp3" --> "C1.mp3", original "Cs0.mp3" --> "C0.mp3"
    // Changed file name because the original "C0.mp3" is higher than the original "Cs0.mp3"
    'metronome': {
        'C1': 'C1.wav',
        'C0': 'C0.wav',
        'C2': 'C2.wav',
    ...
    // from https://freesound.org/people/flcellogrl/
    // 'Cello-freeSound': {
    //     'A2': 'A2.wav',
    //     'A3': 'A3.wav',
    //     'A4': 'A4.wav',
